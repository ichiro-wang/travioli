...
var en = (t, e = new Zr()) => {
    let r = {
      ...
      provider: t.provider,
      startTransaction: async (...n) => (await Ee(e, t.startTransaction.bind(t))(...n)).map((o) => hl(e, o)),
    };
...
var Ml = J("prisma:client:request_handler"),
  br = class {
    ...
    sanitizeMessage(e) {
      return this.client._errorFormat && this.client._errorFormat !== "pretty" ? (0, Io.default)(e) : e;
    }
    unpack(e, r, n) {
